...
function _settingsDetailCats(detail) {
  detail.innerHTML = '<div class="inbox-detail">'
    ...
    + '<input type="checkbox" id="showArchivedCb"' + (showArchivedCats ? ' checked' : '') + ' onchange="toggleShowArchived(this)"> Show archived'
    + '</label>'
    + '<label class="show-archived-label" title="Collapse every category and drag to change their order">'
    + '<input type="checkbox" id="reorderCatsCb"' + (reorderCats ? ' checked' : '') + ' onchange="toggleReorderCats(this)"> Reorder'
    + '</label>'
